...
const Categories = () => {
  ...
  const deleteCategory = async (id) => {
    try {
      await axios.delete(
        `${import.meta.env.VITE_API_BASE}/api/category/delete/${id}`
      );
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        {/* Add Category */}
        <NavLink to="/admin/dashboard/categories/add">
        ...
        <table className="w-full border-collapse">
          ...
          <tbody>
            {filteredCategories.map((c, index) => {
              const image = c.image
                ? `${import.meta.env.VITE_API_BASE}/${c.image}`
              ...
              return (
                <tr key={c._id} className="border-b hover:bg-gray-50">
                  ...
                  <td className="p-3">{c.parent_category_id?.name || "N/A"}</td>
                  <td className="p-3">
                  ...
                  <td className="flex gap-3 p-3">
                    <button
                      ...
                      onClick={() =>
                        navigate(`/admin/dashboard/categories/edit/${c._id}`)
                      }
                    >
                      <FaEdit />
                    </button>
      ...
      {/* agar add category kiya toh woh component */}
